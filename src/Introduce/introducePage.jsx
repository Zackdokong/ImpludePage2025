          ...
          <div className="valueMent">
            <div>
              ...
              <span className="detail">
                ...
                <br />
                좋은 팀워크는 모든 것이 가능하도록 만듭니다.
                <br />
                임플루드는 모두가 서로의 단점을 보완하며
                <br /> 각자의 역량을 인정하는 팀을 지향합니다.
              </span>
            </div>
            <div>
              <span className="theme">자유롭고 편한 소통</span>
              <span className="detail">
                수직적이지 않고 수평적인 분위기를 지향하며, <br />
                모두가 자유롭게 질문하고 의견을 제시하는 분위기를 추구합니다.
              </span>
            </div>
            <div>
              <span className="theme">많은 실전 경험</span>
              <span className="detail">
                임플루드는 책상에 앉아서 배우는 것보다 실제로 적용하며 배우는
                것이 많다고 생각합니다.
                <br /> 많은 실전 경험을 통해 압축적인 성장을 지향합니다.
              </span>
            </div>
            <div>
              <span className="theme">실패를 즐기는</span>
              <span className="detail">
                실패는 성공의 과정에 필연적인 존재입니다.
                <br /> 실패를 통한 깨달음과 성장만 있을 뿐,
                <br /> 실패는 두려운 존재가 아닙니다.
              </span>
            </div>
            <div>
